        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="side-menu">
                            ...
                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <span class="clear">
                                    <span class="block m-t-xs" style="font-size:20px;">
                                        ...
                                        <strong class="font-bold">hSb</strong>
                                    </span>
                                </span>
                            </a>
                        </div>
                        <div class="logo-element">hSb
                        </div>
                    </li>
                    ...
                    <li>
                        <a class="J_menuItem" href="${pageContext.request.contextPath}/userController/index_v1">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="${pageContext.request.contextPath}/userController/user">查看用户</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="${pageContext.request.contextPath}/roleController/role">查看角色</a>
                            </li>
                        </ul>
                    </li>
                </ul>
...
<!--                         <form role="search" class="navbar-form-custom" method="post" action="search_results.html">
            ...
            <div class="row J_mainContent" id="content-main">
                <iframe id="J_iframe" width="100%" height="100%" src="${pageContext.request.contextPath}/userController/index_v1" frameborder="0" data-id="index_v1.html" seamless></iframe>
            </div>
        </div>
        <!--右侧部分结束-->
    </div>
    ...
    <!-- 自定义js -->
    <script src="${pageContext.request.contextPath}/assets/js/hAdmin.js?v=4.1.0"></script>
